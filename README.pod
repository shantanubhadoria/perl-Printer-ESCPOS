...
Refer to the following manuals for to get started with L<Printer::ESCPOS>
...
call write() and other Text formatting functions on $device-E<gt>printer for the data to be sent to the printer. Make sure to end it all with a linefeed $device-E<gt>printer-E<gt>lf().
...
This software is copyright (c) 2015 by Shantanu Bhadoria (https://www.shantanubhadoria.com).
